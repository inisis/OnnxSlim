...
class PatternMapping(dict):
    ...
    def set_input_onnx_tensor(self, onnx_tensor, index):
        """Sets an ONNX tensor at a specified index of the input list, expanding the list if necessary."""
...
class GraphPattern:
    ...
    def _get_outbound(self, tensor_index):
        """Retrieve the outbound node and tensor ID based on the specified tensor index, or return (None, None) if not found."""
