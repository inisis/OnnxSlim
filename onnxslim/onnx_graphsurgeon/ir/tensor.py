...
class LazyValues(object):
    ...
    def __str__(self):
        """Returns a string representation of the LazyValues object with its shape and dtype."""
        return "LazyValues (shape={:}, dtype={:})".format(self.shape, self.dtype)

    def __repr__(self):  # Hack to make logging output pretty.
        """Returns a string representation of the LazyValues object for logging purposes."""
        return self.__str__()
...
class Constant(Tensor):
    ...
    def to_variable(self, dtype: np.dtype = None, shape: Sequence[Union[int, str]] = []):
        """Convert instance values to a variable with specified dtype and shape attributes."""
    ...
    @property
    def values(self):
        """Returns the values of the tensor, loading them if they are accessed for the first time."""
    ...
    def values(self, values: Union[np.ndarray, LazyValues]):
        """Returns the values of the tensor, loading them if accessed for the first time."""
        self._values = values

    @property
    def shape(self):
        """Returns the shape of the tensor values."""
        return self._values.shape

    @property
    def dtype(self):
        """Returns the data type of the tensor values."""
        return self._values.dtype

    @property
    def export_dtype(self):
        """Returns the export data type of the tensor values if specified, otherwise defaults to the tensor's dtype."""
    ...
    def __repr__(self):  # Hack to make logging output pretty.
        """Provides a string representation of the object including its values for enhanced logging output readability."""
        ret = self.__str__()
        ret += "\n{:}".format(self._values)
        return ret
