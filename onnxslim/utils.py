...
class TensorInfo:
    ...
    def _extract_info(self, tensor):
        ...
        self.dtype = onnx.helper.tensor_dtype_to_np_dtype(tensor.type.tensor_type.elem_type) if tensor.type.tensor_type.elem_type in onnx.helper.get_all_tensor_dtypes() else "Unknown"
        shape = None
