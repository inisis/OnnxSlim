...
from onnxslim.core.optimization.dead_node_elimination import dead_node_elimination, check_shape, get_constant_variable
...
class TestDeadNodeElimination:
    ...
    def test_check_shape_function(self):
        ...
        assert check_shape([1, 2, 3, 4]) == True
        
        # One string, rest positive integers
        assert check_shape([1, 2, "batch", 4]) == True
        
        # Multiple strings
        assert check_shape([1, "batch", "seq", 4]) == False
        
        # Negative integers
        assert check_shape([1, -1, 3, 4]) == False
