...
from onnxslim.core.optimization.subexpression_elimination import (
    ...
    find_and_remove_replaceable_nodes,
    can_be_replaced,
    sequences_equal
)
...
class TestSubexpressionElimination:
    ...
    def test_sequences_equal_function(self):
        ...
        seq1 = [1, 2, 3]
        seq2 = [1, 2, 3]
        assert sequences_equal(seq1, seq2) == True

        # Test with different length sequences
        seq3 = [1, 2, 3, 4]
        assert sequences_equal(seq1, seq3) == False

        # Test with same length but different elements
        seq4 = [1, 2, 4]
        assert sequences_equal(seq1, seq4) == False

        # Test with empty sequences
        assert sequences_equal([], []) == True
    ...
    def test_can_be_replaced_function(self):
        ...
        assert can_be_replaced(node1, node5) == False 